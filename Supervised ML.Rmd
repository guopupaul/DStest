...
grubbs.test(w$TP, type = 10, opposite = FALSE, two.sided = FALSE)
grubbs.test(w$TP, type = 10, opposite = TRUE, two.sided = FALSE)
grubbs.test(l$TP, type = 11, opposite = FALSE, two.sided = FALSE)
```
...
boxscores.trim <- boxscores %>% select(-c(RND, TEAM, "3P%", "2P%", "FT%", TR, MIN, TP)) %>%
...
In this case, 5 dimensions > 1 and cover and cover 69% of the variance.
