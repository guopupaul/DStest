...
Although 2PM is below the cutoff, we will nclude it for practical reasons
```{r}
...
Boxscores_tsk = TaskClassif$new(id = "Boxscores", backend = Boxscores.train, target = "RESULT", positive = "1")
Boxscores_tsk
```
...
autoplot(res) + theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
*************************************************************
